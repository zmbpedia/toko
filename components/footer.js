                    ...
                    <div className="row">
                     <div className="col-12 col-sm-6 col-lg-4 mb-lg-0 mb-4">
                            ...
                            <ul className="list-unstyled footerContactList mb-3">
                                <li className="mb-3 d-flex flex-nowrap pr-xl-20 pr-0"><span className="icon icon-place mr-3"></span> <address className="fwEbold m-0">Alamat: Sukamantri, Kec. Tamansari, Bogor, Jawa Barat 16610.</address></li>
                                <li className="mb-3 d-flex flex-nowrap"><span className="icon icon-phone mr-3"></span> <span className="leftAlign"> +62 899-5940-606</span></li>
                                <li className="email d-flex flex-nowrap"><span className="icon icon-email mr-2"></span> <span className="leftAlign">zmbpedia@gmail.com</span></li>
                            </ul>
                        ...
                        <div className="col-12 col-sm-6 col-lg-3 pl-xl-14 mb-lg-0 mb-4">
                            ...
                            <ul className="list-unstyled footerNavList">
                                <li className="mb-1"><a href="#">Katalog produk</a></li>
                                <li className="mb-2"><a href="#">Cara belanja</a></li>
